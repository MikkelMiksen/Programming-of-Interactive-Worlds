...
public class MJ_PlayerStats01 : MonoBehaviour
{
    ...
    [SerializeField] private float fatPct = 60f;  // 0–100: long-term energy & insulation
    [SerializeField] private float fatLossPerHour = 0.03f;
    [SerializeField] private float fatGainPerMeal = 5f;
    [SerializeField] private float starvationThreshold = 25f;

    [Header("Clothing Insulation (0–1 each)")]
    [SerializeField] private float jacketInsulation = 0f;
    [SerializeField] private float pantsInsulation = 0f;
    [SerializeField] private float bootsInsulation = 0f;
    [SerializeField] private float hatInsulation = 0f;
